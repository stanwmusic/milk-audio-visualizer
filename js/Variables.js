define(function () {
    ...
    var PresetVariablePool = Class({
        extends: VariablePool,
        constructor: function () {
            this.super();
    ...
    var PresetFrameVariablePool = Class({
        extends: PresetVariablePool,
        constructor: function () {
            this.super();
    ...
    var PresetPixelVariablePool = Class({
        extends: PresetVariablePool,
        constructor: function () {
            this.super();
    ...
    var WaveFrameVariablePool = Class({
        extends: CustomVariablePool,
    });

    var WavePointVariablePool = Class({
        extends: CustomVariablePool,
        constructor: function () {
            this.super();
    ...
    var ShapeFrameVariablePool = Class({
        extends: CustomVariablePool,
        constructor: function () {
            this.super();
    ...
    return {
        PresetVariablePool: PresetVariablePool,
        PresetFrameVariablePool: PresetFrameVariablePool,
        PresetPixelVariablePool: PresetPixelVariablePool,
        ShapeFrameVariablePool: ShapeFrameVariablePool,
        WaveFrameVariablePool: WaveFrameVariablePool,
        WavePointVariablePool: WavePointVariablePool
    };
});