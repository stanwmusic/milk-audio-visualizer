...
define(function (require) {
    ...
    var RenderItem = Class({
        constructor: function (glu, literal) {
    ...
    var MilkdropWaveform = Class({
        ...
        constructor: function (glu, literal) {
            ...
            this.super(glu, literal);

            this.wavearray = new Float32Array(2048 * 2);
            this.wavearray2 = new Float32Array(2048 * 2);
            this.wavearraybuf = this.gl.createBuffer();
            this.wavearray2buf = this.gl.createBuffer();
        ...
        Draw: function (context) {
            ...
            u.Translatef(.5, .5, 0);
            u.Rotatef(this.rot, 0, 0, 1);
            u.Scalef(this.aspectScale, 1.0, 1.0);
            u.Translatef(-.5, -.5, 0);

            u.EnableClientState(u.VERTEX_ARRAY);
            u.DisableClientState(u.TEXTURE_COORD_ARRAY);
            u.DisableClientState(u.COLOR_ARRAY);

            gl.bindBuffer(gl.ARRAY_BUFFER, this.wavearraybuf);
            gl.bufferData(gl.ARRAY_BUFFER, this.wavearray, gl.STATIC_DRAW);
            u.VertexPointer(2, gl.FLOAT, 0, this.wavearraybuf);

            if (this.loop)
                u.DrawArrays(gl.LINE_LOOP, 0, this.samples);
            else
                u.DrawArrays(gl.LINE_STRIP, 0, this.samples);

            if (this.two_waves) {
                gl.bindBuffer(gl.ARRAY_BUFFER, this.wavearray2buf);
                gl.bufferData(gl.ARRAY_BUFFER, this.wavearray2, gl.STATIC_DRAW);
                u.VertexPointer(2, gl.FLOAT, 0, this.wavearray2buf);
                if (this.loop)
                    u.DrawArrays(gl.LINE_LOOP, 0, this.samples);
                else
                    u.DrawArrays(gl.LINE_STRIP, 0, this.samples);
        ...
        MaximizeColors: function (context) {
            ...
            if (this.maximizeColors) {
                ...
                u.Color4f(wave_r_switch, wave_g_switch, wave_b_switch, this.temp_a * this.masterAlpha);
            } else {
                u.Color4f(this.r, this.g, this.b, this.temp_a * this.masterAlpha);
            }
    ...
    var CustomWaveform = Class({
        extends: RenderItem,
        constructor: function (glu, literal, initialQs) {
            this.r = 0;
            this.g = 0;
            this.b = 0;
            this.a = 0;
            ...
            this.initialVals = new Variables.WaveFrameVariablePool();
            this.initialVals.pushOutputs(this);

            this.framePool = new Variables.WaveFrameVariablePool();
            this.pointPool = new Variables.WavePointVariablePool();
            this.varInit();
        ...
        varInit: function () {
            var testPool = new Variables.WaveFrameVariablePool();
            var winProps = {};
        ...
        Draw: function (context) {
            ...
            if (this.thick) {
                gl.lineWidth(context.texsize <= 512 ? 2 : 2 * context.texsize / 512);
                u.PointSize(context.texsize <= 512 ? 2 : 2 * context.texsize / 512);
            } else {
                u.PointSize(context.texsize <= 512 ? 1 : context.texsize / 512);
            }
            ...
            u.EnableClientState(u.VERTEX_ARRAY);
            u.EnableClientState(u.COLOR_ARRAY);
            u.DisableClientState(u.TEXTURE_COORD_ARRAY);

            gl.bindBuffer(gl.ARRAY_BUFFER, this.pbuf);
            gl.bufferData(gl.ARRAY_BUFFER, this.p, gl.STATIC_DRAW);
            u.VertexPointer(2, gl.FLOAT, 0, this.pbuf);

            gl.bindBuffer(gl.ARRAY_BUFFER, this.colorbuf);
            gl.bufferData(gl.ARRAY_BUFFER, this.colors, gl.STATIC_DRAW);
            u.ColorPointer(4, gl.FLOAT, 0, this.colorbuf);

            if (this.dots) {
                u.DrawArrays(gl.POINTS, 0, this.samples);
            } else {
                u.DrawArrays(gl.LINE_STRIP, 0, this.samples);
            }
    ...
    var DarkenCenter = Class({
        ...
        constructor: function (glu, literal) {
            ...
            this.pointsbuf = this.gl.createBuffer();
        },
        ...
        Draw: function (context) {
            ...
            u.EnableClientState(u.COLOR_ARRAY);
            u.DisableClientState(u.TEXTURE_COORD_ARRAY);
            u.VertexPointer(2, gl.FLOAT, 0, this.pointsbuf);
            u.ColorPointer(4, gl.FLOAT, 0, this.colorbuf);
            u.DrawArrays(gl.TRIANGLE_FAN, 0, 6);
        }
    });
    ...
    var Shape = Class({
        ...
        constructor: function (glu, literal, initialQs) {
            ...
            this.initialVals = new Variables.ShapeFrameVariablePool();
            this.initialVals.pushOutputs(this);

            this.framePool = new Variables.ShapeFrameVariablePool();
            this.varInit();
            this.framePool.pushQs(initialQs);
            this.init_code(this.framePool);
            this.initialTs = new Float32Array(8);
        ...
        varInit: function () {
            var testPool = new Variables.ShapeFrameVariablePool();
            for (var i = 0; i < 30; i++)
                try {
                    this.init_code(testPool);
                    this.per_frame_code(testPool);
        ...
        Draw: function (context) {
            ...
            if (this.textured) {
                ...
                u.MatrixMode(u.TEXTURE);
                u.PushMatrix();
                u.LoadIdentity();

                u.EnableClientState(u.VERTEX_ARRAY);
                u.EnableClientState(u.COLOR_ARRAY);
                u.EnableClientState(u.TEXTURE_COORD_ARRAY);

                u.VertexPointer(2, gl.FLOAT, 0, this.pointsbuf);
                u.ColorPointer(4, gl.FLOAT, 0, this.colorbuf);
                u.TexCoordPointer(2, gl.FLOAT, 0, this.texbuf);
                ...
                u.DrawArrays(gl.TRIANGLE_FAN, 0, this.sides + 2);
            ...
            u.EnableClientState(u.VERTEX_ARRAY);
            u.DisableClientState(u.COLOR_ARRAY);
            u.VertexPointer(2, gl.FLOAT, 0, this.points2buf);

            u.Color4f(this.border_r, this.border_g, this.border_b, this.border_a * this.masterAlpha);
            ...
            u.DrawArrays(gl.LINE_LOOP, 0, this.sides);
            if (this.thickOutline)
                gl.lineWidth(context.texsize < 512 ? 1 : context.texsize / 512);
        }
    });

    var MotionVectors = Class({
        extends: RenderItem,
        constructor: function (glu, literal) {
        ...
        Draw: function () {
            ...
            u.PointSize(this.length);
            u.Color4f(this.r, this.g, this.b, this.a * this.masterAlpha);
    ...
    var Border = Class({
        ...
        Draw: function () {
            ...
            gl.enable(gl.BLEND);
            gl.blendFunc(gl.SRC_ALPHA, gl.ONE_MINUS_SRC_ALPHA);
            u.Color4f(this.outer_r, this.outer_g, this.outer_b, this.outer_a * this.masterAlpha);
            ...
            u.VertexPointer(2, gl.FLOAT, 0, this.pointsAbuf);
            u.DrawArrays(gl.TRIANGLE_STRIP, 0, 4);
            ...
            u.VertexPointer(2, gl.FLOAT, 0, this.pointsBbuf);
            u.DrawArrays(gl.TRIANGLE_STRIP, 0, 4);
            ...
            u.VertexPointer(2, gl.FLOAT, 0, this.pointsCbuf);
            u.DrawArrays(gl.TRIANGLE_STRIP, 0, 4);
            ...
            u.VertexPointer(2, gl.FLOAT, 0, this.pointsDbuf);
            u.DrawArrays(gl.TRIANGLE_STRIP, 0, 4);

            u.Color4f(this.inner_r, this.inner_g, this.inner_b, this.inner_a * this.masterAlpha);
            ...
            u.VertexPointer(2, gl.FLOAT, 0, this.pointsEbuf);
            u.DrawArrays(gl.TRIANGLE_STRIP, 0, 4);
            ...
            u.VertexPointer(2, gl.FLOAT, 0, this.pointsFbuf);
            u.DrawArrays(gl.TRIANGLE_STRIP, 0, 4);
            ...
            u.VertexPointer(2, gl.FLOAT, 0, this.pointsGbuf);
            u.DrawArrays(gl.TRIANGLE_STRIP, 0, 4);
            ...
            u.VertexPointer(2, gl.FLOAT, 0, this.pointsHbuf);
            u.DrawArrays(gl.TRIANGLE_STRIP, 0, 4);
        }
    });
    ...
    var VideoEcho = Class({
        extends: RenderItem,
        constructor: function (u, literal) {
            this.a = 0;
            this.zoom = 0;
        ...
        Draw: function (context) {
            ...
            u.TexCoordPointer(2, gl.FLOAT, 0, this.tex);
            ...
            u.Color4f(1.0, 1.0, 1.0, this.a * this.masterAlpha);
            u.Translatef(.5, .5, 0);
            u.Scalef(1.0 / this.zoom, 1.0 / this.zoom, 1);
            u.Translatef(-.5, -.5, 0);
            ...
            u.VertexPointer(2, gl.FLOAT, 0, this.pointsFlipbuf);
            u.DrawArrays(gl.TRIANGLE_FAN, 0, 4);

            u.DisableClientState(U_TEXTURE_COORD_ARRAY);
            gl.blendFunc(gl.SRC_ALPHA, gl.ONE_MINUS_SRC_ALPHA);
        }
    });
    ...
    var Brighten = Class({
        ...
        Draw: function (context) {
            ...
            uEnableClientState(u.VERTEX_ARRAY);
            gl.bindBuffer(gl.ARRAY_BUFFER, this.pointsbuf);
            gl.bufferData(gl.ARRAY_BUFFER, this.points, gl.STATIC_DRAW);
            u.VertexPointer(2, gl.FLOAT, 0, this.pointsbuf);
            u.Color4f(1.0, 1.0, 1.0, 1.0);
            gl.enable(gl.BLEND);
            ...
            u.DrawArrays(gl.TRIANGLE_FAN, 0, 4);
            gl.blendFunc(gl.SRC_ALPHA, gl.ONE_MINUS_SRC_ALPHA);
            u.DisableClientState(u.VERTEX_ARRAY);
        }
    });
    ...
    var Darken = Class({
        ...
        Draw: function (context) {
            ...
            u.DrawArrays(gl.TRIANGLE_FAN, 0, 4);
            gl.blendFunc(gl.SRC_ALPHA, gl.ONE_MINUS_SRC_ALPHA);
            u.DisableClientState(U_VERTEX_ARRAY);
        }
    });
